...
fun RegisterLayout(
    ...
    secondPasswordField: TextFieldData,
    intents: Intents,
    ...
    AdunScaffold(
        ...
        appBar = {
            FloatingAppBar(
                label = stringResource(Res.strings.screen_registration_title),
        ...
        Column(
            ...
            CenterContent(
                ...
                onSecondPasswordChange = intents.changeSecondPassword,
                onLoginClick = intents.login,
                modifier = Modifier
...
private fun Header(
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.strings.screen_registration_header),
        ...
        Text(
            text = stringResource(Res.strings.screen_registration_desc),
            color = AppTheme.colors.text.primary,
...
private fun CenterContent(
    ...
    val secondPasswordRequester = remember { FocusRequester() }
    ...
    Column(
        ...
        ContentLabel(
            ...
            PasswordTextField(
                ...
                actions = KeyboardActions(
                    onNext = { secondPasswordRequester.requestFocus() }
                ),
        ...
        ContentLabel(
            label = resRef(Res.strings.repeat_password)
        ) {
            PasswordTextField(
                data = secondPasswordField,
                onValueChange = onSecondPasswordChange,
                enabled = enabled,
                modifier = Modifier.focusRequester(secondPasswordRequester),
            )
        }

        FlowRow {
            Text(
                text = stringResource(Res.strings.screen_registration_alredy_have_account) + " ",
                color = AppTheme.colors.text.primary,
                style = AppTheme.typography.body2
            )
            Text(
                text = stringResource(Res.strings.button_login),
                color = AppTheme.colors.text.accent,
                style = AppTheme.typography.body2,
                modifier = Modifier.click(Clickable.of(onLoginClick))
            )
        }
    }
}
